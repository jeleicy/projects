...
class FuncionesControllers extends Controller {
	...
	public static function buscar_pruebas($id) {
		$sql = "select tp.* 
				...
				where b.id=".$id." and btp.id_tipo_prueba=tp.id and btp.id_bateria=b.id order by btp.orden";
		$data=DB::select($sql);
		$texto="<ul>";
		...
		if ($i==2) {
			...
			$resultado = '
				<div id="prueba" style="border: solid 0px; border-color: red; width:70%; float:left;">
					...
					<div align="left" style="margin-left:7%;"><strong>Seleccione la opcion que considere mas adecuada...</strong></div>
			...
			$resultado = '
				...
				<div id="texto_ejemplo" style="border: 2px solid red; color: red;display:none; width: 70%; float: left; margin: 20px; padding:10px;"></div>
			';
		} elseif ($i==9) {
			$resultado = '
			<div id="prueba3_sl_cont" style="margin-left:10%; width:60%; border: 0px solid green; text-align:left;">
				...
				<div id="prueba1_pc_cont">				
					<div id="prueba1_pc_resp">
						<div id="prueba1_pc_txt" class="clase_iep">Huye corriendo del lugar.
			...
			$resultado = '
						<div id="prueba3_sl_cont1">
							<br /><br />
							<div id="prueba3_sl_preg" style="width: 100%;">Disfruto conversar sobre cualquier tema.</div>
							<br /><br />
							<table border=0 width="70%" align="center">
								<tr>
									<td align="right"><strong>en Desacuerdo: </strong></td><td colspan="2">&nbsp;</td>
								</tr>
								<tr>
									<td width="50%" align="right">Completamente</td>
									<td><input onclick="fortaleza_texto(1)" class="radio_ifh"  type="radio" name="op_1" id="op_1" value="1"></td>
									<td><div style="color: red;" id="des_com"></div></td>
								</tr>
								<tr>
									<td width="50%" align="right">Moderadamente</td>
									<td><input onclick="fortaleza_texto(2)" class="radio_ifh"  type="radio" name="op_1" id="op_1" value="2"></td>
									<td><div style="color: red;" id="des_mod"></div></td>
								</tr>
								<tr>
									<td width="50%" align="right">Ligeramente</td>
									<td><input onclick="fortaleza_texto(3)" class="radio_ifh"  type="radio" name="op_1" id="op_1" value="3"></td>
									<td><div style="color: red;" id="des_lig"></div></td>
								</tr>
								<tr>
									<td align="right"><strong>de Acuerdo: </strong></td><td colspan="2">&nbsp;</td>
								</tr>
								<tr>
									<td width="50%" align="right">Ligeramente</td>
									<td><input onclick="fortaleza_texto(4)" class="radio_ifh" type="radio" name="op_1" id="op_1" value="4"></td>
									<td><div style="color: red;" id="acu_lig"></div></td>
								</tr>
								<tr>
									<td width="50%" align="right">Moderadamente</td>
									<td><input onclick="fortaleza_texto(5)" class="radio_ifh"  type="radio" name="op_1" id="op_1" value="5"></td>
									<td><div  style="color: red;"id="acu_mod"></div></td>
								</tr>
								<tr>
									<td width="50%" align="right">Completamente</td>
									<td><input onclick="fortaleza_texto(6)" class="radio_ifh"  type="radio" name="op_1" id="op_1" value="6"></td>
									<td><div style="color: red;" id="acu_com"></div></td>
								</tr>
							</table>
						</div>
			';
			...
			foreach ($valores as $key=>$value) {
				if (strpos($tipo_campo,"MULTIPLE") !== false) {
					...
					//foreach ($valor_multiple as $k=>$v) {
						//echo "value=""...valor=$valor<br>";
						//$checked="";
						$valor_x=explode(".",$valor);
						//print_r($valor_x);
						for ($m=0; $m<count($valor_x); $m++) {
							if ($valor_x[$m]==$valor_multiple[0]) {
								//echo $valor_x[$m]."==".$valor_multiple[0]."<br>";
								$checked="checked";
								break;
							} else
								$checked="";
						...
						/*if (strpos($valor_multiple[0],$valor) !== false)
							$checked="checked";
						else
							$checked="";*/
					//}
					//echo "<br>checked=$checked...valor_multiple=".$valor_multiple[0]."...valor=$valor...pos=".strpos($valor_multiple[0],$valor)."<br>";
					$res.="<div align='left'>
								<input $checked type='checkbox' id='valores_chk_".$id."_".$i."' name='valores_chk_".$id."_".$i."' value='".$value."'>
								&nbsp;&nbsp;&nbsp;".strtoupper($value)."
							</div>";
					$i++;
				} else {
