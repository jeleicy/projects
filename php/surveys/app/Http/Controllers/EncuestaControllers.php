...
class EncuestaControllers extends Controller {
    ...
    {       
		...
		echo 'ttt = '.$fecha_reporte1; return;
		...
		// else
		// 	return view('encuesta.encuesta_reporte',["id_grupo_candidatos"=>0,"id_tipo_prueba"=>$itp,"cedula"=>0,'fecha_reporte1'=>$fecha_reporte1,'fecha_reporte2'=>$fecha_reporte2]);
    }
...
<div id="titulo" class="titulo" align="center">Perfil de Competencia Básicas</div>			
		';
...
$tabla .= '
	<table>
		...
		$texto_final="";
		$texto_final="Ahora la Empresa dispone de una valiosa información sobre su Perfil de Competencias, lo que permitirá fundamentar con mayor propiedad sus decisiones. Gracias por el tiempo dedicado a esta actividad.";

		if ($recibe==1 || Session::get("rol")=="EA" || Session::get("rol")=="ERRHH")
			echo $tabla;
		else
