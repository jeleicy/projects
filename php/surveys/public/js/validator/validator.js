...
var validator = (function($){
	...
	*/
	message = {
		...
		min				: 'La entrada es muy corta, revise',
		max				: 'La entrada es muy larga, revise',
		number_min		: 'Numero Invalido',
		number_max		: 'Numero Invalido',
		url				: 'URL Invalida',
		number			: 'Numero Invalido',
		email			: 'Correo electronico invalido',
		email_repeat	: 'Los Correos no son iguales',
		password_repeat	: 'Contraseñas no son iguales',
		repeat			: 'No coincide',
		complete		: 'El campo no esta compleo, revise',
		select			: 'Por favor seleccione al menos una opcion'
	};
