...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("claseBotones"),
		finish  : $('<a id="send_encuesta" name="send_encuesta">Comenzar<br />Prueba</a>').attr("onclick","guardar_encuesta_co_ejemplo()").addClass("btn btn-danger")
    };
    /*
     * Private functions
     */
		...
		*/
        ...
        $($this.buttons.next).click(function() {
			...
			if ($("#coord_"+pregunta_actual_co).val()==respuesta_actual_co[pregunta_actual_co]) {
				...
				entrada++;
				$this.goForward();
				$("#coord_"+pregunta_actual_co).focus();
				tabindex++;
			} else
    ...
    SmartWizard.prototype.goForward = function(){
        ...
        _loadContent(this, nextStepIdx);
		//alert("#coord_"+pregunta_actual_co);
		$("#coord_"+pregunta_actual_co).focus();
    };
