...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        finish  : $('<a id="send" name="send">'+boton+'</a>').attr("onclick","guardar_encuesta_hl()").addClass("btn btn-danger")
    };
    ...
    SmartWizard.prototype.goForward = function() {
		...
		if (opciones_iep<2 && nro_prueba==5)
			alert("No podra pasar de pregunta hasta no contestar la opcion + y - !!!");
		else {
			opciones_iep=0;
			...
			_loadContent(this, nextStepIdx);
			//setTimeout(function(){$("[tabindex='" + (primera[palabra]) + "']").focus();}, 1);    

			//$("[tabindex='" + (primera[palabra]) + "']").focus();
		}
    };
