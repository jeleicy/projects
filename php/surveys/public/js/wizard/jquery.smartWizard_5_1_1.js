...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        finish  : $('<a>'+boton+'</a>').attr("onclick","guardar_encuesta_op(1)").addClass("btn btn-danger")
    };
    ...
    var _init = function($this) {
        ...
        $($this.buttons.next).click(function() {
			...
			if (valor_pregunta==respuesta_pregunta) {
				...
				$("#valor").html("Su respuesta es INCORRECTA, la respuesta correcta es: <strong>"+respuesta_pregunta+"</strong>. Intente nuevamente");
				$("#ap_"+pregunta_actual_co).val("");
			}			
            return false;
        });
