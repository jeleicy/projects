...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("onclick","ver_pregunta()").addClass("btn btn-success"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary"),
		finish  : $('<a id="send" name="send">Finalizar</a>').attr("onclick","guardar_encuesta_co()").addClass("btn btn-danger")
    };
    ...
    var _init = function($this) {
        var elmActionBar = $('<div align="center"></div>').addClass("actionBar");
		...
		$(".input_text").keydown(function() {
			...
			if (evt.keyCode==13) {
					...
					//var fields = $(this).parents('forma_1_'+currentTabIndex+':eq(0),body').find('input');
					currentTabIndex++;
					...
					if ( index > -1 && ( index + 1 ) < fields.length ) {
						currentTabIndex++;
						//alert("currentTabIndex="+currentTabIndex+"....index="+index+"....len="+fields.length)
						index++;
						$this.goForward();
					...
					$this.goForward();
					return false;
					//var forma=currentTabIndex;					
					//$("[tabindex='" + (currentTabIndex) + "']").focus();
					//$(this).next('input').focus();
					//alert("forma_1_"+forma);
					//var f=eval("document.forma_1_"+forma);					
					//alert($("#forma_1_"+forma+":"+this).val());					
					//$("form:[tabindex='"+currentTabIndex+"']").focus();									
					//return false;					
			} /*else {
				//return false;
			}*/
    ...
    var _setupStep = function($this, curStep, selStep) {
		...
		if (currentTabIndex>0) {
			var f=eval("document.forms["+currentTabIndex+"]");
			document.getElementById(f.elements[0].id).focus();		
			document.getElementById(f.elements[0].id).focus();		
		}
    };
