...
use App\Http\Controllers\Sessiontexto_aceptacionControllers;
		...
		<div class="form-group">
			<div class="dataTable_wrapper">
				<table width="100%" class="table table-striped table-bordered table-hover" id="tabla_reportes">
					...
					<tbody>
						<?php
							$sql = "select * from texto_aceptacion order by 2";
							$data=DB::select($sql);
							...
							foreach ($data as $data) {
								?>
									<tr>
										...
										<th><?php echo FuncionesControllers::buscar_bateria($data->id_bateria); ?></th>
										<th><?php echo FuncionesControllers::buscar_empresa($data->id_empresa); ?></th>
										<th><?php echo $activo[$data->activa]; ?></th>
										<th>
											<a href='consultartexto_aceptacion/<?php echo $data->id; ?>'>Consultar</a>
											<!--a href='eliminartexto_aceptacion/<?php echo $data->id; ?>'>Eliminar</a-->
										</th>
									</tr>								
								<?php
							}
