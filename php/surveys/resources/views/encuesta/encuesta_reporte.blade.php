...
@include('layout.header')
    ...
    <div class="container">
    {!! Form::open(array('url' => 'consultar_encuesta', 'onsubmit'=>'Javascript: prox_pagina()', 'method' => 'get', 'class' =>  "form-horizontal", 'files'=>true)) !!}
		<input type="hidden" name="id_tipo_prueba" value="<?=$id_tipo_prueba?>">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Reportes de {{ $nombre_prueba }}</h1>			
				<div class="col-lg-12 text-center">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">		
						<select class="form-control" id="id_grupo_candidatos" name="id_grupo_candidatos">
							...
							{{ FuncionesControllers::crear_combo('grupo_candidatos', $id_grupo_candidatos) }}
						</select>		
					</div>
				</div>
	...
	<?php if (isset($fecha_reporte1)) { ?>
		<div class="form-group">
			@include($reporte, ['id_tipo_prueba' => $id_tipo_prueba, 'nombre_prueba'=>$nombre_prueba, 'id_grupo_candidatos'=>$id_grupo_candidatos])
		</div>
	<?php } ?>
