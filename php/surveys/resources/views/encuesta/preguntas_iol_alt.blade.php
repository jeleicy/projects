									...
									<form name="forma<?php echo $i; ?>" class="form-horizontal form-label-left">
										<div align='center' style='background: #fff; position: relative; border: 2px solid red; height:230px; width: 98%; border-radius: 15px 50px 30px; margin: 5px; padding: 5px;'>
											<table border=0 align="center">
												<?php
													$sql = "select * from opciones_iol_alt
																...
																<div class="container">
																	<div class="row">																
																		<div class="form-group" align="center">
																			<label style="margin-left: 50%; position: relative; text-align: center; margin:0; border: 0px solid green; width:30%">
																				...
																				<div class="col-sm-7 col-md-7">
																					...
																					<label id="label_mas_<?php echo $data2->id; ?>_<?php echo $i; ?>" style="margin: 0; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
																						<input class="radio_iol" value="<?php echo $data2->id; ?>" type="radio" name="mas_<?php echo $i; ?>" id="mas_<?php echo $i; ?>" onclick="validar('mas',<?php echo $i; ?>,<?php echo $data2->id; ?>, this)" />&nbsp;&nbsp;&nbsp;<img height="15" width="15" src="../imagenes/positivo.gif" border=0 />
																						&nbsp;&nbsp;&nbsp;
																					</label>
																					<label id="label_menos_<?php echo $data2->id; ?>_<?php echo $i; ?>" style="margin: 0 ; border-radius: 15px 50px 30px; cursor: pointer; background: #c8c8c8">
																						<input class="radio_iol" value="<?php echo $data2->id; ?>" type="radio" name="menos_<?php echo $i; ?>" id="menos_<?php echo $i; ?>" onclick="validar('menos',<?php echo $i; ?>,<?php echo $data2->id; ?>, this)" />&nbsp;&nbsp;&nbsp;<img height="15" width="15" src="../imagenes/negativo.gif" border=0 />
																						&nbsp;&nbsp;&nbsp;
																					</label>
																				</div>
																			</label>
