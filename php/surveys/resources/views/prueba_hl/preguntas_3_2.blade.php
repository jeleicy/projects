...
<script>nro_prueba=3; id_au=<?=$id_au?>; primera=new Array(); var num_actual=0; palabra=0;</script>
...
<table border=0 width="80%">
	...
	<tr>
		<td align="center">
			<!--PREGUNTAS-->
			<!-- Smart Wizard -->
			<div id="wizard_3" align="center" class="form_wizard wizard_horizontal" style="margin: 0px; padding: 0px; text-align: center">
				<?php 
					$sql = "select * from preguntas_hl where id_pruebas=1 and id_preguntas>9";
					$data=DB::select($sql);
					$cantidad_1=1;
					$primera="";
					foreach ($data as $data) {
						...
						$valor="";
						?>
						<div id="step-<?php echo $cantidad_1; ?>" align="center" style="line-height: 150%; text-align: center;">
							<form name="forma<?php echo $cantidad_1; ?>" class="form-horizontal">
								<div align="center" style="top:0px; position: relative;">									
									...
									for ($i=0; $i<count($pregunta); $i++) {
										...
										if ($i==0) {
											$autofocus="autofocus";
											echo "<script>primera[".$num."]='coord_".$id_pregunta."_".$complemento."'; </script>";
											$num++;
										} else
											$autofocus="";
										
										echo "<td><input autocomplete='off' tabindex=$tabindex $autofocus class='clase' maxlength='2' onKeyPress='return soloNumeros(event)' style='width:50px; text-align: center' type='text' name='coord_".$id_pregunta."_".$complemento."' id='coord_".$id_pregunta."_".$complemento."' value='$valor'></td>";
										$tabindex++;
									}
