...
$(document).ready(function() {
	...
	$(".clase_textos").keydown(function(event) {
		...
		if (event.keyCode==13) {
			...
			alert("1cant_caracteres="+cant_caracteres+"....1cantidad="+cantidad+"....1cant_preguntas="+cant_preguntas);			
			if (cant_caracteres>tab) {
				$("[tabindex='"+tab+"']").focus();
			} else {
				if (cant_preguntas>cantidad) {
					alert("2cant_caracteres="+cant_caracteres+"....2cantidad="+cantidad+"....2cant_preguntas="+cant_preguntas);
					document.getElementById("finalizar").style.display = "none";
					document.getElementById("anterior").style.display = "inline";
					document.getElementById("siguiente").style.display = "inline";
					document.getElementById("prueba"+cantidad).style.display = "none";
					cantidad++;
					document.getElementById("prueba"+cantidad).style.display = "inline";					
				} else {
					document.getElementById("finalizar").style.display = "inline";
					document.getElementById("anterior").style.display = "inline";
					document.getElementById("siguiente").style.display = "none";
