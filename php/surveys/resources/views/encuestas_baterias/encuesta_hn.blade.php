...
<div id="contenedor" style="border: 2px solid green; position: relative;">
<!-- HEADER -->
...
<div id="instrucciones" align="center" style="display:inline;">
	...
	@include('encuestas_baterias.instrucciones',["boton"=> "1", "nro_inst"=>8, "titulo"=>$titulo,"instrucciones_antes"=>$instrucciones_antes,"instrucciones_despues"=>$instrucciones_despues, "tiempo"=>$tiempo, "funcion"=>"guardar_encuesta_hn"])
...
?>
	...
	<?php $funcion="guardar_encuesta_hn"; ?>
