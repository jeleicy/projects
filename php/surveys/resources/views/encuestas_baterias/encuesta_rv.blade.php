...
<div id="instrucciones" align="center" style="display:inline;">
	...
	@include('encuestas_baterias.instrucciones',["boton"=> "1", "id_au"=>$id_au, "nro_inst"=>7, "titulo"=>$titulo,"instrucciones_antes"=>$instrucciones_antes,"instrucciones_despues"=>$instrucciones_despues, "tiempo"=>$tiempo, "funcion"=>"guardar_encuesta_rv"])
</div>	
<!-- INSTRUCCIONES -->
...
<div id="prueba{{ $tabindex }}" style="display: {{ $display }};">
	...
	<br /><br /><br />	
	<div id="prueba2_sl_cont4" style="padding-left:60px;" style="border: 0px solid green; padding-left:30px;">
...
<?php $funcion="guardar_encuesta_rv"; ?>
