...
<div align="center">
<?php 
	$sql = "select * from preguntas_co where id_pruebas=1 and id_preguntas>3 and id_preguntas<58 order by orden";
	$data=DB::select($sql);
	$cantidad=4;
	echo "<script>tabindex=".$cantidad.";</script>";
	foreach ($data as $data) {
		...
		<div align="center" style="display: {{ $display }};" id="prueba{{ $tabindex }}">
			<div class="prueba1_sl_txt" style="width: 100%">{{ $pregunta }}
