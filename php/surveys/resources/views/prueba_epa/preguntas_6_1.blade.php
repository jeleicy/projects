											...
											<div style="top:0px; position: relative;">									
												...
												echo "<table border=0 align='center'>
														...
														echo "<td align='center'>
																...
																<input $autofocus tabindex=$tabindex maxlength='2' class='input_text' style='width:50px; height:35px; text-align: center; font-weight:bold;' type='text' name='coord_".$id_pregunta."' id='coord_".$id_pregunta."' value='$valor'>
															  </td>";
													echo "</tr>
												</table>";									
												$tabindex++;
