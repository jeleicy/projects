...
<form name="forma" action="guardar_correo_nuevo" method="post" class="form-horizontal" onsubmit="mirar_texto()">
		
		<input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
		<input type="hidden" name="texto" id="texto" value="" />

        <h2>Nueva correo</h2> <hr />
<div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="asunto" name="asunto" type="text" data-validate-length-range="3" data-validate-words="1" required="required" class="form-control" placeholder="Asunto" value="">
            </div>
        </div>		
