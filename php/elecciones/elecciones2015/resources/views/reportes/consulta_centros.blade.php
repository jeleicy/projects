...
<table id="example" class="display" cellspacing="0" width="100%">
   ...
   //  {
        ...
        if ($nombre!="")
            $sql .= "nombre like '".strtoupper($nombre)."%' and ";

        if ($estado!=0)
            $sql .= "estado=$estado and ";

        if ($municipio!=0)
            $sql .= "municipio=$municipio and ";

        if ($parroquia!=0)
            $sql .= "parroquia=$parroquia and ";
...
<br /><br />
<div align="center">
    <input class="btn btn-primary" type="button" name="Imprimir Tablero" value="Imprimir Tablero" onclick="imprimir_tablero('T', this.form)" />
